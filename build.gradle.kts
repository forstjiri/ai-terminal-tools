...
intellijPlatform {
    ...
    pluginConfiguration {
        ...
        name = "OpenCode / Claude Code / Pi / Codex TUI integration"
        version = project.version.toString()
        description = """
            Use your favorite TUI AI coding agent inside IntelliJ with superpowers!

            <p>
              🛠️ There are many tools that integrate OpenCode, Claude Code, Pi, or Codex, but complex GUIs never perfectly mirror TUI functionality. On the flip side, pure TUI tools often lack seamless interaction between the IDE and the terminal.
              <br><br>
            ...
            <ul>
              ...
              <li>📤 <strong>Send context:</strong> Easily send editor selections, file paths, dragged files, and console error blocks directly to your active OpenCode, Claude Code, Pi, or Codex terminal.</li>
              <li>🔍 <strong>Diff review:</strong> Review file changes from each OpenCode, Claude Code, Pi, or Codex turn side-by-side using the native IntelliJ diff window.</li>
